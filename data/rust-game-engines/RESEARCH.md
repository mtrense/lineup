...
- [ ] **Bevy** — Flagship pure-Rust engine; ECS-first, data-driven, wgpu renderer, huge community and plugin ecosystem
- [ ] **Fyrox** — Full 3D/2D engine with a native visual scene editor and resource manager (formerly rg3d)
- [ ] **Macroquad** — Minimal, extremely fast-compiling cross-platform 2D/3D framework built on miniquad; excellent web support
