/**
 * Icon-attribute test for ui-component-libraries — framework.
 *
 * Verifies that:
...
import uiAttributes from "../../../../data/ui-component-libraries/attributes.json";

describe("ui-component-libraries: framework icon attribute", () => {
  const vt = getTagsAttribute(uiAttributes, "framework-architecture", "framework");
