...
model: opus
allowed-tools: Read, Glob, Write, Edit, Bash(date:*), Bash(gh repo *), Bash(bash .scripts/validate-json.sh *), WebFetch, WebSearch
...
```bash
bash .scripts/validate-json.sh data/<type>/<candidate-id>.json data/<type>/index.json
```
