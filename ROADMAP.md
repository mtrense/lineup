...
0019-single-comparison-html-export.md — [completed] `pnpm export <type>` produces a self-contained, interactive single-comparison HTML file reusing the app's components.
